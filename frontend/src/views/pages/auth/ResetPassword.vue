...
onMounted(async () => {
  ...
  if (!token.value) {
    ...
    toast.add({
      ...
      detail: 'No reset token was provided in the URL.',
      life: 5000
    });
    return;
  }
      ...
      <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
        <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
          <div class="text-center mb-8">
            ...
            <span class="text-muted-color font-medium">Create your new password</span>
          </div>

          <div v-if="!tokenValid" class="text-center">
            <p class="text-red-500">Invalid or expired password reset link.</p>
            <Button label="Back to Login" class="mt-4" as="router-link" to="/auth/login" />
          </div>
            ...
            <div class="flex flex-col gap-4">
              <div>
                ...
                <Password
                  ...
                  class="w-full"
                />
                <small class="text-muted-color">Password must be at least 8 characters and include an uppercase letter, a number, and a special character.</small>
              </div>
              ...
              <div>
                ...
                <Password
                  ...
                  toggleMask
                  class="w-full"
                  :class="{ 'p-invalid': password !== confirmPassword && confirmPassword }"
                />
                <small v-if="password !== confirmPassword && confirmPassword" class="text-red-500">Passwords do not match</small>
              </div>
